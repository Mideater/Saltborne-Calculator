...
How the project is put together, how to run it locally, and how to publish it on GitHub Pages. If you just want to USE the calculator, see README.md instead.
